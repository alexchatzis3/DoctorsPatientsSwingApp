...
public class PatientsUpdateDeleteFrame extends JFrame {
	...
	public PatientsUpdateDeleteFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(PatientsUpdateDeleteFrame.class.getResource("/resources/medical.png")));
		...
		patientsTable.setBounds(34, 56, 189, 273);
		contentPane.add(patientsTable);
		...
		updateBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        // Checks if patient is chosen
		        if (idStr.isEmpty()) {
		            JOptionPane.showMessageDialog(null, "Please select a patient from the table first.", "No Patient Selected", JOptionPane.WARNING_MESSAGE);
		            return;
		        }
	...
	private void buildTable() {
		...
		String sql = "SELECT id, firstname, lastname FROM patients WHERE lastname LIKE ?";
